...
TEST_CASE("Rigid motion test")
{
  ...
  SECTION("RigidMotion: Pure R2 Motions")
  {
    ...
    SECTION("Identity R2")
    {
      rigidmotion::RigidMotion f = rm2f.makeIdentity();
      arma::mat Y = rme.apply(f, R2X);
      arma::mat Z = abs(Y - R2X);
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
      REQUIRE(rigidmotion::RigidMotion::SuperType::R2_BASE ==
              f.findSuperType());
      REQUIRE(f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::IDENTITY_R2 == f.findType());
      REQUIRE(f.findInvariantDimensionality() == 2);
      size_t dim;
      arma::mat L = rme.computeFixedPoints(f, dim);
      arma::mat EL = arma::eye(2, 2);
      REQUIRE(!arma::any(arma::vectorise(abs(L - EL)) > eps));
    }

    SECTION("Translation R2")
    {
      arma::colvec shift({ 1.67, -2.27 });
      rigidmotion::RigidMotion f = rm2f.makeTranslation(shift);
      arma::mat Y = rme.apply(f, R2X);
      ...
      REQUIRE(rigidmotion::RigidMotion::SuperType::R2_BASE ==
              f.findSuperType());
      REQUIRE(!f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::TRANSLATION_R2 == f.findType());
      REQUIRE(f.findInvariantDimensionality() == 2);
      try {
        size_t dim;
        arma::mat L = rme.computeFixedPoints(f, dim);
    ...
    {
      arma::colvec axis({ 2.1, -3.9 });
      arma::colvec X({ -3, 1 });
      rigidmotion::RigidMotion f = rm2f.makeReflection(axis);
      arma::colvec Y = rme.apply(f, X);
      arma::colvec EY({ 0.81651376, 3.05504587 });
      REQUIRE(!arma::any(arma::vectorise(abs(Y - EY)) > eps));
      REQUIRE(rigidmotion::RigidMotion::SuperType::R2_REFLECTION ==
              f.findSuperType());
      REQUIRE(f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::REFLECTION_R2 == f.findType());
      ...
      arma::mat EY2(2, 5);
      EY2.at(0, 0) = 0.12385321;
      EY2.at(1, 0) = 2.91284404;
      EY2.at(0, 1) = 0.69266055;
      EY2.at(1, 1) = 0.14220183;
      EY2.at(0, 2) = 1.26146789;
      EY2.at(1, 2) = -2.62844037;
      EY2.at(0, 3) = 1.83027523;
      EY2.at(1, 3) = -5.39908257;
      EY2.at(0, 4) = 2.39908257;
      EY2.at(1, 4) = -8.16972477;
      ...
      arma::mat EY3(2, 5);
      EY3.at(0, 0) = -0.63793103;
      EY3.at(1, 0) = -2.84482759;
      EY3.at(0, 1) = -0.70689655;
      EY3.at(1, 1) = -0.01724138;
      EY3.at(0, 2) = -0.77586207;
      EY3.at(1, 2) = 2.81034483;
      EY3.at(0, 3) = -0.84482759;
      EY3.at(1, 3) = 5.63793103;
      EY3.at(0, 4) = -0.9137931;
      EY3.at(1, 4) = 8.46551724;
      Z = abs(Y3 - EY3);
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
    }
    ...
    {
      arma::colvec axis({ 2.1, 1.9 });
      rigidmotion::RigidMotion f = rm2f.makeGlideReflection(axis, 2);
      arma::mat Y = rme.apply(f, R2X);
      arma::mat EY(2, 5);
      EY.at(0, 0) = 2.7262137;
      EY.at(1, 0) = -1.29533046;
      EY.at(0, 1) = 0.93569001;
      EY.at(1, 1) = 0.89419573;
      EY.at(0, 2) = -0.85483368;
      EY.at(1, 2) = 3.08372191;
      EY.at(0, 3) = -2.64535737;
      EY.at(1, 3) = 5.27324809;
      EY.at(0, 4) = -4.43588106;
      EY.at(1, 4) = 7.46277428;
      arma::mat Z = abs(Y - EY);
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
      REQUIRE(rigidmotion::RigidMotion::SuperType::R2_REFLECTION ==
              f.findSuperType());
      REQUIRE(!f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::GLIDE_REFLECTION_R2 ==
              f.findType());
      REQUIRE(f.findInvariantDimensionality() == 1);
      size_t dim;
      ...
      rigidmotion::RigidMotion g = rm2f.makeReflection(axis);
      rigidmotion::RigidMotion h = rme.compose(f, g);
    ...
    SECTION("Rotation R2")
    {
      arma::colvec center = R2X.col(2);
      rigidmotion::RigidMotion f = rm2f.makeRotation(-M_PI / 3, center);
      arma::mat Y = rme.apply(f, R2X);
      arma::mat EY(2, 5);
      EY.at(0, 0) = 2.96410162;
      EY.at(1, 0) = 2.96410162;
      EY.at(0, 1) = 2.23205081;
      EY.at(1, 1) = 0.23205081;
      EY.at(0, 2) = 1.5;
      EY.at(1, 2) = -2.5;
      EY.at(0, 3) = 0.76794919;
      EY.at(1, 3) = -5.23205081;
      EY.at(0, 4) = 0.03589838;
      EY.at(1, 4) = -7.96410162;
      arma::mat Z = abs(Y - EY);
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
      REQUIRE(rigidmotion::RigidMotion::SuperType::R2_ROTATION ==
              f.findSuperType());
      REQUIRE(f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::ROTATION_R2 == f.findType());
  ...
  SECTION("RigidMotion: Pure R3 Motions")
  {
    ...
    SECTION("Identity R3")
    {
      rigidmotion::RigidMotion f = rm3f.makeIdentity();
      arma::mat Y = rme.apply(f, R3X);
      arma::mat Z = abs(Y - R3X);
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
      REQUIRE(rigidmotion::RigidMotion::SuperType::R3_BASE ==
              f.findSuperType());
      REQUIRE(f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::IDENTITY_R3 == f.findType());
    ...
    {
      arma::colvec shift({ 1.1, -3.39, 0.24 });
      rigidmotion::RigidMotion f = rm3f.makeTranslation(shift);
      arma::mat Y = rme.apply(f, R3X);
      ...
      REQUIRE(rigidmotion::RigidMotion::SuperType::R3_BASE ==
              f.findSuperType());
      REQUIRE(!f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::TRANSLATION_R3 == f.findType());
      REQUIRE(f.findInvariantDimensionality() == 3);
    }

    SECTION("Reflection R3")
    {
      arma::colvec ortho({ 1.0, 0.5, 0.3 });
      rigidmotion::RigidMotion f = rm3f.makeReflection(ortho);
      arma::mat Y = rme.apply(f, R3X);
      arma::mat EY("0.3358209 0.24626866 -0.82835821 1.41044776 -1.99253731; "
      ...
      Z = abs(Y - R3X);
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
      REQUIRE(rigidmotion::RigidMotion::SuperType::R3_REFLECTION ==
              f.findSuperType());
      REQUIRE(f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::REFLECTION_R3 == f.findType());
      REQUIRE(f.findInvariantDimensionality() == 2);
      size_t dim;
      arma::mat L = rme.computeFixedPoints(f, dim);
      if (L(0, 0) < 0)
    ...
    {
      arma::colvec ortho({ 1.0, 0.5, 0.3 });
      arma::colvec shift({ -4.0 / 5.0, 1, 1 });
      rigidmotion::RigidMotion f = rm3f.makeGlideReflection(ortho, shift);
      arma::mat Y = rme.apply(f, R3X);
      arma::mat EY =
      ...
      REQUIRE(rigidmotion::RigidMotion::SuperType::R3_REFLECTION ==
              f.findSuperType());
      REQUIRE(!f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::GLIDE_REFLECTION_R3 ==
              f.findType());
      REQUIRE(f.findInvariantDimensionality() == 2);
      size_t dim;
      arma::mat L = rme.computeAssociatedInvariant(f, dim);
      ...
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
      try {
        f = rm3f.makeGlideReflection(ortho, arma::colvec("1 1 1"));
        FAIL("Should have thrown RigidMotionException");
      } catch (rigidmotion::RigidMotionException&) {
        SUCCEED();
      }
    ...
    SECTION("Rotation R3")
    {
      arma::colvec axis({ 0.4, 0.2, 1.0 });
      double theta = 4.5;
      rigidmotion::RigidMotion f = rm3f.makeRotation(axis, theta);
      arma::mat Y = rme.apply(f, R3X);
      arma::mat EY(
      ...
      arma::mat Z = abs(Y - EY);
      REQUIRE(!arma::any(arma::vectorise(Z) > eps));
      REQUIRE(rigidmotion::RigidMotion::SuperType::R3_ROTATION ==
              f.findSuperType());
      REQUIRE(f.hasFixedPoints());
      REQUIRE(rigidmotion::RigidMotion::Type::ROTATION_R3 == f.findType());
      REQUIRE(f.findInvariantDimensionality() == 1);
      size_t dim;
      arma::mat L = rme.computeFixedPoints(f, dim);
      if (L(0, 0) < 0)
  ...
  SECTION("RigidMotion: Helios Dynamic Motions")
  {
    ...
    SECTION("Identity R3")
    {
      ...
      rigidmotion::RigidMotion id = rm3f.makeIdentity();
    ...
    {
      DynMovingObject dynObj = dmo;
      rigidmotion::RigidMotion tr =
        rm3f.makeTranslation(arma::colvec("-0.1;0.1;0"));
    ...
    SECTION("Reflection R3")
    {
      ...
      rigidmotion::RigidMotion rf = rme.compose(
    ...
    SECTION("Glide Reflection R3")
    {
      ...
      rigidmotion::RigidMotion rf = rme.compose(
        rm3f.makeTranslation(O),
        rme.compose(rm3f.makeGlideReflection(arma::colvec("0;0;1"),
                                             arma::colvec("0.5;0.5;0")),
                    rm3f.makeTranslation(-O)));
      DynMotion dm(rm3f.makeGlideReflection(arma::colvec("0;0;1"),
                                            arma::colvec("0.5;0.5;0")),
                   true);
      validate_dyn_motion(dm, rf, dynObj);
    }
    ...
    SECTION("Rotation R3")
    {
      DynMovingObject dynObj = dmo;
      arma::colvec O = dmo.getCentroid();
      rigidmotion::RigidMotion rot = rme.compose(
        rm3f.makeTranslation(O),
    ...
    SECTION("Helical R3")
    {
      DynMovingObject dynObj = dmo;
      arma::colvec O = dmo.getCentroid();
      rigidmotion::RigidMotion hm = rme.compose(
        rm3f.makeTranslation(O),
    ...
    SECTION("Rotational Symmetry R3")
    {
      DynMovingObject dynObj = dmo;
      arma::colvec O = dmo.getCentroid();
      rigidmotion::RigidMotion rs =
        rme.compose(rm3f.makeTranslation(O),
                    rme.compose(rm3f.makeRotationalSymmetryZ(0.34),
                                rm3f.makeTranslation(-O)));
